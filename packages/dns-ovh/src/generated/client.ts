...
export type Domain_zone_RecordUpdate = { readonly "subDomain"?: string, readonly "target"?: string, readonly "ttl"?: number }
export const Domain_zone_RecordUpdate = Schema.Struct({ "subDomain": Schema.optionalKey(Schema.String), "target": Schema.optionalKey(Schema.String), "ttl": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())) })
export type Domain_zone_Record = { readonly "fieldType"?: Domain_zone_RecordTypeEnum, readonly "id"?: number, readonly "subDomain"?: string, readonly "target"?: string, readonly "ttl"?: number, readonly "zone"?: string }
export const Domain_zone_Record = Schema.Struct({ "fieldType": Schema.optionalKey(Domain_zone_RecordTypeEnum), "id": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "subDomain": Schema.optionalKey(Schema.String), "target": Schema.optionalKey(Schema.String), "ttl": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "zone": Schema.optionalKey(Schema.String) })
export type Domain_zone_RecordCreate = { readonly "fieldType": Domain_zone_RecordTypeEnum, readonly "id"?: number, readonly "subDomain"?: string, readonly "target": string, readonly "ttl"?: number, readonly "zone"?: string }
export const Domain_zone_RecordCreate = Schema.Struct({ "fieldType": Domain_zone_RecordTypeEnum, "id": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "subDomain": Schema.optionalKey(Schema.String), "target": Schema.String, "ttl": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "zone": Schema.optionalKey(Schema.String) })
// schemas
