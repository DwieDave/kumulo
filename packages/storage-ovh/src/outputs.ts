...
import type { BucketSpec, ClusterTag } from "@kumulo/core"
...
export const outputsPath = ({ dir, tag }: { readonly dir: string; readonly tag: ClusterTag }): string =>
  `${dir.endsWith("/") ? dir.slice(0, -1) : dir}/${tag}.buckets.yaml`
...
export const stringifyOutputsYaml = (file: OutputsFile): string => stringify({ cluster: file.cluster, buckets: file.buckets })
