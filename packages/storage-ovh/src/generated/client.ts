...
export const Cloud_StorageReplicationRuleFilter = Schema.Struct({ "prefix": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "tags": Schema.optionalKey(Schema.Union([Schema.Record(Schema.String, Schema.String), Schema.Null])) })
...
export const Cloud_StorageContainerCreation = Schema.Struct({ "encryption": Schema.optionalKey(Schema.Union([Cloud_StorageEncryptionObject, Schema.Null])), "lifecycle": Schema.optionalKey(Schema.Union([Cloud_StorageLifecycleConfiguration, Schema.Null])), "name": Schema.String, "objectLock": Schema.optionalKey(Schema.Union([Cloud_StorageLockConfiguration, Schema.Null])), "ownerId": Schema.optionalKey(Schema.Union([Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt()), Schema.Null])), "replication": Schema.optionalKey(Schema.Union([Cloud_StorageReplicationObjectIn, Schema.Null])), "tags": Schema.optionalKey(Schema.Union([Schema.Record(Schema.String, Schema.String), Schema.Null])), "versioning": Schema.optionalKey(Schema.Union([Cloud_StorageVersioningObject, Schema.Null])) })
