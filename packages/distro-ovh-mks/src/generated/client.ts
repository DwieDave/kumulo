...
export const Cloud_ProjectKubeCustomizationCiliumHubbleRelay = Schema.Struct({ "enabled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationKubeProxyIptables = Schema.Struct({ "minSyncPeriod": Schema.optionalKey(Schema.Union([Schema.String.annotate({ "format": "duration" }), Schema.Null])), "syncPeriod": Schema.optionalKey(Schema.Union([Schema.String.annotate({ "format": "duration" }), Schema.Null])) })
export type Cloud_ProjectKubeIpAllocationPolicy = { readonly "podsIpv4Cidr"?: string | null, readonly "servicesIpv4Cidr"?: string | null }
export const Cloud_ProjectKubeIpAllocationPolicy = Schema.Struct({ "podsIpv4Cidr": Schema.optionalKey(Schema.Union([Schema.String.annotate({ "format": "ipv4Block" }), Schema.Null])), "servicesIpv4Cidr": Schema.optionalKey(Schema.Union([Schema.String.annotate({ "format": "ipv4Block" }), Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationCiliumClusterMeshApiServer = Schema.Struct({ "nodePort": Schema.optionalKey(Schema.Union([Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt()), Schema.Null])), "serviceType": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumClusterMeshApiServerServiceTypeEnum, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationCiliumHubbleUIResources = Schema.Struct({ "limits": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeResources, Schema.Null])), "requests": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeResources, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationCiliumClusterMesh = Schema.Struct({ "apiServer": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumClusterMeshApiServer, Schema.Null])), "enabled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationCiliumHubbleUI = Schema.Struct({ "backendResources": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumHubbleUIResources, Schema.Null])), "enabled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "frontendResources": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumHubbleUIResources, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationKubeProxy = Schema.Struct({ "iptables": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationKubeProxyIptables, Schema.Null])), "ipvs": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationKubeProxyIpvs, Schema.Null])) })
...
export const Cloud_ProjectKubeCustomizationCilium = Schema.Struct({ "clusterId": Schema.optionalKey(Schema.Union([Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt()), Schema.Null])), "clusterMesh": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumClusterMesh, Schema.Null])), "hubble": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeCustomizationCiliumHubble, Schema.Null])) })
...
export const Cloud_ProjectKubeCreationNodePool = Schema.Struct({ "antiAffinity": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "attachFloatingIps": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeNodePoolAttachFloatingIpsParams, Schema.Null])), "autoscale": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "autoscaling": Schema.optionalKey(Cloud_ProjectKubeNodePoolAutoscalingParams), "availabilityZones": Schema.optionalKey(Schema.Union([Schema.Array(Schema.String), Schema.Null])), "desiredNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "flavorName": Schema.String, "maxNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "minNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "monthlyBilled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "name": Schema.optionalKey(Schema.String), "template": Schema.optionalKey(Cloud_kube_NodePoolTemplate) })
...
export const Cloud_ProjectKubeNodePoolUpdate = Schema.Struct({ "attachFloatingIps": Schema.optionalKey(Schema.Union([Cloud_ProjectKubeNodePoolAttachFloatingIpsParams, Schema.Null])), "autoscale": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "autoscaling": Schema.optionalKey(Cloud_ProjectKubeNodePoolAutoscalingParams), "desiredNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "maxNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "minNodes": Schema.optionalKey(Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt())), "nodesToRemove": Schema.optionalKey(Schema.Array(Schema.String)), "template": Schema.optionalKey(Cloud_kube_NodePoolTemplate) })
