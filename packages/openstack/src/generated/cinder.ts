...
export const TypesListResponse = Schema.Struct({ "volume_types": Schema.optionalKey(Schema.Array(Schema.Struct({ "description": Schema.optionalKey(Schema.String), "extra_specs": Schema.optionalKey(Schema.Record(Schema.String.check(Schema.isPattern(new RegExp("^[a-zA-Z0-9-_:.]{1,255}$"))), Schema.Union([Schema.String.check(Schema.isMinLength(0)).check(Schema.isMaxLength(255))]))), "id": Schema.optionalKey(Schema.String.annotate({ "format": "uuid" })), "is_public": Schema.optionalKey(Schema.Boolean), "name": Schema.optionalKey(Schema.String), "os-volume-type-access:is_public": Schema.optionalKey(Schema.Boolean), "qos_specs_id": Schema.optionalKey(Schema.String.annotate({ "format": "uuid" })) }))) })
